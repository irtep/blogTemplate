...
var ItemInCenter = function (_Component) {
  _inherits(ItemInCenter, _Component);

  function ItemInCenter() {
    _classCallCheck(this, ItemInCenter);

    return _possibleConstructorReturn(this, (ItemInCenter.__proto__ || Object.getPrototypeOf(ItemInCenter)).apply(this, arguments));
  }

  _createClass(ItemInCenter, [{
    key: "render",
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "blogPost", onClick: function onClick() {
            return _this2.props.handleClick(_this2.props.title);
          } },
...
var MenuItem = function (_Component) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        "div",
        { className: "menuItems", onClick: function onClick() {
            return _this2.props.handleClick(_this2.props.title);
          } },
        _react2.default.createElement(
          "span",
...
var _itemincenter = __webpack_require__(15);

var _itemincenter2 = _interopRequireDefault(_itemincenter);

var _dbhandler = __webpack_require__(17);

var getArticles = _interopRequireWildcard(_dbhandler);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.state = {
      ...
      infoBoxes: ["Soy una viajera que encanta viajar y vivir en diferentes países con mi maravilloso esposo.", "Articulos:", "Si quires contactarme, por favor mandame un correo electrónico. Gracías"],
      articles: [],
      articlesSet: false
    };
  ...
  _createClass(App, [{
    ...
    key: 'clickControl',
    value: function clickControl(sideMenu, toCenter) {
      var _this2 = this;

      var article1 = sessionStorage.getItem("article1");
      var articlex = [];
      ...
      setTimeout(function () {
        // timed for nicer fadeout/in effect.
        _this2.setState({ showInCenter: sideMenu, articles: articlex, articlesSet: true });
      }, 600);
    ...
    value: function render() {
      ...
      var forCenterPage = [this.state.infoBoxes[0]]; // default
      var whatIsClicked = this.state.showInCenter; // new
      var isArticle = false;
      var articleNumber = 0;
      var copiedArts = this.state.articles;
      ...
      for (var ii = 0; ii < copiedArts[0].length; ii++) {
      ...
      if (isArticle === true) {
        var copyOfArticle = this.state.articles[0][articleNumber];
        forCenterPage = [];
        forCenterPage.push(copyOfArticle.subject);
        console.log("pushed subject from: ", copyOfArticle);

        for (var ix = 0; ix < copyOfArticle.paragraphs.length; ix++) {
          forCenterPage.push(copyOfArticle.paragraphs[ix]);
        }
      } else {
        console.log("not center click. Activating switch");
        ...
        switch (this.state.showInCenter) {
          case "Quien soy?":
            ...
            break;
          case "Blog posts":
            // make this to work as array as well, and make a map action down there
            var copyState = this.state.articles;
            var articleTitles = [];
            for (var i = 0; i < copyState[0].length; i++) {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'theApp container-fluid' },
        _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'col-md-2' },
              this.state.sideMenus.map(function (sideMenu) {
                return _react2.default.createElement(_menuitem2.default, {
                  title: sideMenu,
                  handleClick: _this3.clickControl,
                  key: _this3.id
                });
              })
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'blogPosts' },
                forCenterPage.map(function (toCenter) {
                  return _react2.default.createElement(_itemincenter2.default, {
                    title: toCenter,
                    handleClick: _this3.clickControl,
                    key: _this3.id
                  });
...
*/
var ba=__webpack_require__(1),m=__webpack_require__(5),A=__webpack_require__(2),C=__webpack_require__(3),ea=__webpack_require__(8),fa=__webpack_require__(10),ha=__webpack_require__(6),ja=__webpack_require__(7);
...
var m=__webpack_require__(2),n=__webpack_require__(12),p=__webpack_require__(4),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.portal"):60106,u=q?Symbol["for"]("react.fragment"):60107,v=q?Symbol["for"]("react.strict_mode"):60108,w=q?Symbol["for"]("react.provider"):60109,x=q?Symbol["for"]("react.context"):60110,y=q?Symbol["for"]("react.async_mode"):60111,z=q?Symbol["for"]("react.forward_ref"):60112,A="function"===
